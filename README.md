...
-   Basic usage: create an OpenLayers map instance, and pass that map and options to the Street View constructor.
    -   [Basic](https://raw.githack.com/GastonZalba/ol-street-view/v1.0.1/examples/basic.html)
...
```HTML
<script src="https://unpkg.com/ol-street-view@1.0.1"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://unpkg.com/ol-street-view@1.0.1/dist/css/ol-street-view.min.css" />
```
