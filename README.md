...
- [Basic usage](https://raw.githack.com/GastonZalba/ol-street-view/v3.0.2/examples/basic.html): create an OpenLayers map instance, and pass that map and options to the Street View constructor. 
- [Manually Load Google Maps Library](https://raw.githack.com/GastonZalba/ol-street-view/v3.0.2/examples/manually-load-maps.html). By default, the Google Maps Library is auto loaded by this module, but it can be disabled if you have already loaded it in another place, or if you want to use a custom Google Maps version.
...
```HTML
<script src="https://unpkg.com/ol-street-view@3.0.2"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://unpkg.com/ol-street-view@3.0.2/dist/css/ol-street-view.min.css" />
```
