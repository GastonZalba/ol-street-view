...
class StreetView {
  ...
  _prepareLayout() {
    ...
    var addStreetViewHtml = () => {
      ...
      this.mapContainer.id = 'ol-street-view--map-container'; // Move the map element (viewport) inside a new container
    ...
    var addPegmanInteraction = () => {
      ...
      interact('.ol-street-view--draggable').draggable({
        ...
        onend: e => {
          ...
          var location = this.map.getCoordinateFromPixel([e.client.x - mapDistanceY, e.client.y + this.pegmanDraggable.clientHeight]);
