...
class StreetView {
    ...
    var addPegmanInteraction = () => {
      ...
      var mousemovemethod = e => {
        ...
        if (e.pageX < oldx) {
          ...
          this.pegmanDraggable.classList.remove('right'); // Right
      ...
      interact('.ol-street-view--draggable').draggable({
        inertia: false,
        onmove: e => {
          document.addEventListener('mousemove', mousemovemethod.bind(this)); // Remove Class 'dropped' if Exists
        ...
        onend: e => {
          ...
          this._initPegmanOnMap(); // Reset Pegman Dragging Cursor
      ...
      interact(this.viewport).dropzone({
        ...
        ondragenter: e => {
          ...
          this.pegmanDraggable.classList.add('active'); // Feedback the Possibility of a Drop
        ...
        ondrop: () => {
          this.pegmanDraggable.classList.add('dropped'); // Reset Pegman Dragging Cursor
  ...
  _initStreetView() {
    ...
    this._panorama.addListener('pov_changed', () => {
      var heading = this._panorama.getPov().heading;
