    ...
    var addPegmanInteraction = () => {
      ...
      interact('.ol-street-view--draggable').draggable({
        ...
        onmove: e => {
          ...
          document.addEventListener('mousemove', this._onMouseMove); // Remove Class 'dropped' if Exists
        ...
        onend: e => {
          var location = this.map.getCoordinateFromPixel([e.client.x - 60, e.client.y + this.pegmanDraggable.clientHeight]);
      ...
      interact(this.viewport).dropzone({
        ...
        ondragenter: () => {
          ...
          this.pegmanDraggable.classList.add('ol-street-view--active', 'ol-street-view--can-drop'); // Feedback the Possibility of a Drop
        ...
        ondrop: () => {
          this.pegmanDraggable.classList.add('ol-street-view--dropped'); // Reset Pegman Dragging Cursor
