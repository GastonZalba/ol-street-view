    ...
    var addPegmanInteraction = () => {
      ...
      interact('.ol-street-view--draggable').draggable({
        ...
        onend: e => {
          ...
          var location = this.map.getCoordinateFromPixel([e.client.x - 25, e.client.y + this.pegmanDraggable.clientHeight]);
