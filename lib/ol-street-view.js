    ...
    var addPegmanInteraction = () => {
      ...
      interact('.ol-street-view--draggable').draggable({
        ...
        onend: e => {
          ...
          var mapDistanceY = this.mapContainer.offsetLeft - this.mapContainer.scrollLeft + this.mapContainer.clientLeft;
          console.log(mapDistanceY); // Compensate cursor offset
  ...
  _updateStreetViewPosition(coords) {
    ...
    streetViewService.getPanoramaByLocation(latLonGoogle, SV_MAX_DISTANCE_METERS, (_, status) => {
      if (status === google.maps.StreetViewStatus.OK) {
        ...
        this._updatePegmanPosition(coords,
        /** transform = */
        false);
      }
    });
