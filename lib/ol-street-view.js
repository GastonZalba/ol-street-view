    ...
    var addPegmanInteraction = () => {
      ...
      interact('.ol-street-view--draggable').draggable({
        ...
        onend: e => {
          ...
          var mapDistanceY = this.mapContainer.offsetLeft - this.mapContainer.scrollLeft + this.mapContainer.clientLeft; // Compensate cursor offset

          var location = this.map.getCoordinateFromPixel([e.client.x - mapDistanceY, e.client.y + this.pegmanDraggable.clientHeight - 10]);
